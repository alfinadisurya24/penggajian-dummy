...
@section('content')
    <div class="mt-10 mx-10">
        ...
        @endif
        <a class="bg-green-500 hover:bg-green-700 text-white font-bold py-3 px-4 rounded" href="{{ route('employee.create') }}">Tambah Pegawai</a>
                ...
                @if (count($data) > 0)
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <a href="{{ route('employee.edit', $item->id) }}" class="mr-6 text-indigo-600 hover:text-indigo-900">Edit</a>
